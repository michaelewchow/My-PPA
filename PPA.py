...
class PPA:
    ...
    date_start    = []                                                                             # start date of the PPA energy contract 
    date_end      = []                                                                             # end date of the PPA energy contract
    ...
    price_ppa_set = []                                                                             # PPA price set based on PPA price properties, tenor, forecast electricity prices
    ...
    def build_ppa_price(self, spot_price_forecast):
        ...
        # Update PPA object
        self.price_ppa_set = ppa_price

        return self.price_ppa_set
    ...
    def compute_ppa_npv(self,sett_freq):
        ...
        # Compute undiscounted cash flows
        price_diff   = spot_prices - self.price_ppa_set        
